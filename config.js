...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://imgur.com/a/URM7AuF";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "©ᴀmᴛᴀ ᴍᴅ",
  author: process.env.PACK_AUTHER || "ᴀsᴛᴀ ᴍᴅ",
  packname: process.env.PACK_NAME || "MUJAHID",
  botname: process.env.BOT_NAME || "ᴀMJ BOTᴛᴀ ᴍᴅ",
  ownername: process.env.OWNER_NAME || "ᴀMUJAHUDᴛᴀ",
